    ...
    <v-navigation-drawer v-model="drawer" :mobile-breakpoint="1024" class="elevation-3 full-height" fixed app>
      ...
      <v-list class="pt-0">
        <v-list-item to="/" router exact dense>
          <v-list-item-action>
            <v-img alt="home-icon" :src="`${$router.base || '/'}icon.png`" style="width: 24px" />
          </v-list-item-action>
          <v-list-item-content>
      ...
      <v-list>
        ...
        >
          <v-list-item-action>
            <v-img :alt="item.title" :src="`${$router.base || '/'}${item.icon.slice(1)}`" style="width: 24px" />
          </v-list-item-action>
          <v-list-item-content>
